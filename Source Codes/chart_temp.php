<?php
  ...
  include 'db.class.php';
	...
	function getTempData($DBStmt, $from, $to){
		$DBStmt->query = "SELECT * FROM `temperatures` WHERE dDateTime BETWEEN '$from' and '$to'";
		$HasData = false;
		if ($DBStmt->execute()) {
			$str = "";
...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
		 ...
		 var arrdata = "<?php getTempData($DBStmt, $_REQUEST['from'], $_REQUEST['to']);?>";
		 
		 if(arrdata.length > 0)
		 {
			//document.getElementById('curve_chart').innerHTML  = "With Data";
			var data = google.visualization.arrayToDataTable([
			  ['Date Time', ''],<?php getTempData($DBStmt, $_REQUEST['from'], $_REQUEST['to']);?>
			]);
			var options = {
			  curveType: 'function',
  ...
  <body style="background-image: url(img/OurTeam.jpeg);">
  <div align="center"/>
    <h1  style="color:lightgreen;">Temperature Sensor <?php echo "'(".$_REQUEST['from'].'~'.$_REQUEST['to']. ")'";?></h1>
	<h1  style="color:lightgreen;">Temperature Level</h1>
    <h2  style="color:lightgreen;">45-1000(Above Normal Level)</h2>
	<h2  style="color:lightgreen;">0-45(Normal Level)</h2>
