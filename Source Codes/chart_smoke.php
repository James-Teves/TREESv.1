<?php
  ...
  include 'db.class.php';
	...
	function getSmokeData($DBStmt, $from, $to){
		$DBStmt->query = "SELECT * FROM `smokes` WHERE dDateTime BETWEEN '$from' and '$to'";
		$HasData = false;
		if ($DBStmt->execute()) {
			$str = "";
...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
		 ...
		 var arrdata = "<?php getSmokeData($DBStmt, $_REQUEST['from'], $_REQUEST['to']);?>";
		 
		 if(arrdata.length > 0)
		 {
			//document.getElementById('curve_chart').innerHTML  = "With Data";
			var data = google.visualization.arrayToDataTable([
			  ['Date Time', ''],<?php getSmokeData($DBStmt, $_REQUEST['from'], $_REQUEST['to']);?>
			]);
			var options = {
			  curveType: 'function',
  ...
  <body style="background-image: url(img/slideshow/ForestFires.jpg);">
  <div align="center"/>
    <h1  style="color:white;">Smoke Sensor <?php echo "'(".$_REQUEST['from'].'~'.$_REQUEST['to']. ")'";?></h1>
	<h1  style="color:white;">Threshold Level</h1>
    <h2  style="color:white;">120-1000(Above Normal Level)</h2>
	<h2  style="color:white;">0-120(Normal Level)</h2>
